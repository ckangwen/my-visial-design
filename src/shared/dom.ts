export const getDOMPadding = (dom: Element) => {
  return {
...
export const getDOMMargin = (dom: Element) => {
  return {
...
export const getDOMInfo = (dom: Element) => {
  const {
    x,
    y,
    top,
...
export const getComputedStyle = (dom: Element) => {
  return window.getComputedStyle(dom);
};

export const styleInFlow = (el: Element, parent: Element) => {
